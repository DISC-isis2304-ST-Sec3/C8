...
INSERT INTO ReservasServicio (duracion_hora, dia, hora, Habitaciones_id)
VALUES (5, TO_DATE('2023-11-04','YYYY-MM-DD'),'12:00:00',3);

UPDATE reservas
SET fecha_inicio = TO_DATE('2023-01-15','YYYY-MM-DD'), fecha_salida = TO_DATE('2023-01-20','YYYY-MM-DD')
WHERE id = 4;
...
INSERT INTO Consumos (Habitaciones_id, TiposServicio_tipo, descripcion, costo, fecha_consumo)
VALUES (1, 'spa', 'Eduardo Benitez se hizo un masaje', (SELECT costo FROM ServiciosSpa WHERE id = 1), TO_DATE('2023-10-01','YYYY-MM-DD'));
...
-- Para RFC2
INSERT INTO consumos (habitaciones_id, tiposservicio_tipo, descripcion, costo, fecha_consumo) 
values (3, 'spa', 'Consumo spa', 50000, TO_DATE('2023-08-10','YYYY-MM-DD'));
INSERT INTO consumos (habitaciones_id, tiposservicio_tipo, descripcion, costo, fecha_consumo) 
values (3, 'restaurante', 'Comida', 200000, TO_DATE('2023-01-10','YYYY-MM-DD'));
INSERT INTO consumos (habitaciones_id, tiposservicio_tipo, descripcion, costo, fecha_consumo) 
values (4, 'bar', 'Bebidas', 5000000, TO_DATE('2023-02-10','YYYY-MM-DD'));

--- Para RFC3
INSERT INTO Reservas (fecha_inicio, fecha_salida, num_personas, Usuarios_tipo_documento, Usuarios_num_documento, Usuarios_correo, Usuarios_nombre, PlanesConsumo_id)
VALUES (TO_DATE('2023-11-01','YYYY-MM-DD'),TO_DATE('2023-11-30','YYYY-MM-DD'), 3, 'CE', 1765432, 'e.benitez@gmail.com', 'Eduardo benitez', 1);

INSERT INTO Reservas (fecha_inicio, fecha_salida, num_personas, Usuarios_tipo_documento, Usuarios_num_documento, Usuarios_correo, Usuarios_nombre, PlanesConsumo_id)
VALUES (TO_DATE('2023-11-01','YYYY-MM-DD'),TO_DATE('2023-11-30','YYYY-MM-DD'), 2, 'CC', 333333333, 'r.ardila@gmail.com', 'Ricardo Ardila', 1);

INSERT INTO Reservas (fecha_inicio, fecha_salida, num_personas, Usuarios_tipo_documento, Usuarios_num_documento, Usuarios_correo, Usuarios_nombre, PlanesConsumo_id)
VALUES (TO_DATE('2023-11-01','YYYY-MM-DD'),TO_DATE('2023-11-30','YYYY-MM-DD'), 3, 'CC', 111111112, 's.cardona@gmail.com', 'Susana Cardona', 1);

INSERT INTO Reservas (fecha_inicio, fecha_salida, num_personas, Usuarios_tipo_documento, Usuarios_num_documento, Usuarios_correo, Usuarios_nombre, PlanesConsumo_id)
VALUES (TO_DATE('2023-05-01','YYYY-MM-DD'),TO_DATE('2023-07-30','YYYY-MM-DD'), 3, 'CC', 111111112, 's.cardona@gmail.com', 'Susana Cardona', 1);
...
--- RFC5
INSERT INTO CONSUMOS (habitaciones_id, tiposservicio_tipo, descripcion, costo, fecha_consumo)
values (1,'bar', 'Bebidas', 150000,'02/11/2023' );

--- RFC6
--- A)
INSERT INTO Reservas (fecha_inicio, fecha_salida, num_personas, Usuarios_tipo_documento, Usuarios_num_documento, Usuarios_correo, Usuarios_nombre, PlanesConsumo_id)
VALUES (TO_DATE('2023-07-29','YYYY-MM-DD'),TO_DATE('2023-08-02','YYYY-MM-DD'), 3, 'CE', 1765432, 'e.benitez@gmail.com', 'Eduardo benitez', 2);
INSERT INTO Reservan (Habitaciones_id, Reservas_id)
VALUES (1,7);

INSERT INTO Reservas (fecha_inicio, fecha_salida, num_personas, Usuarios_tipo_documento, Usuarios_num_documento, Usuarios_correo, Usuarios_nombre, PlanesConsumo_id)
VALUES (TO_DATE('2023-01-01','YYYY-MM-DD'),TO_DATE('2023-01-02','YYYY-MM-DD'), 3, 'CE', 1765432, 'e.benitez@gmail.com', 'Eduardo benitez', 2);
INSERT INTO Reservan (Habitaciones_id, Reservas_id)
VALUES (1,8);
INSERT INTO Reservas (fecha_inicio, fecha_salida, num_personas, Usuarios_tipo_documento, Usuarios_num_documento, Usuarios_correo, Usuarios_nombre, PlanesConsumo_id)
VALUES (TO_DATE('2023-05-29','YYYY-MM-DD'),TO_DATE('2023-06-02','YYYY-MM-DD'), 3, 'CE', 1765432, 'e.benitez@gmail.com', 'Eduardo benitez', 2);
INSERT INTO Reservan (Habitaciones_id, Reservas_id)
VALUES (1,9);
...
--- RFC7
INSERT INTO CONSUMOS (habitaciones_id, tiposservicio_tipo, descripcion, costo, fecha_consumo)
values (2,'restaurante', 'Pago comida para 100 personas', 150150000,'02/11/2023' );

INSERT INTO CONSUMOS (habitaciones_id, tiposservicio_tipo, descripcion, costo, fecha_consumo)
values (2,'supermercado', 'Compras', 125000,'02/11/2023' );
